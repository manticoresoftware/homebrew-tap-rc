...
class ManticoresearchRc < Formula
  ...
  base_url = 'https://repo.manticoresearch.com/repository/manticoresearch_macos/release_candidate/'
  ...
  depends_on "unixodbc"
  depends_on "zstd"
  depends_on "manticoresoftware/tap/manticore-backup-rc" => :recommended
  depends_on "manticoresoftware/tap/manticore-buddy-rc" => :recommended
  depends_on "manticoresoftware/tap/manticore-icudata-rc" => :recommended
